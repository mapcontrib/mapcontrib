...
export default Marionette.LayoutView.extend({
    ...
    _onSelect(model) {
        ...
        this.options.router.navigate(`admin/locale/${locale}/preset/edit/${uuid}`, true);
    },

    _onSelectCategory(model) {
        const uuid = model.get('uuid');
        const locale = this.options.locale;
        this.options.router.navigate(`admin/locale/${locale}/preset/category/edit/${uuid}`, true);
    },
    ...
    _onClickBack() {
        ...
        const locale = this.options.locale;
        this.options.router.navigate(`admin/locale/${locale}/preset/${parentUuid}`, true);
    },
