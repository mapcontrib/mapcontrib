...
export default Marionette.LayoutView.extend({
  ...
  commandSetTitleColor(color) {
    ...
    this.ui.titleWrapper.addClass(color).removeClass(this._currentTitleColor);
  ...
  onClickFavorite() {
    ...
    this.ui.favoriteButton.find('i').toggleClass('fa-star fa-star-o');
  }
});
