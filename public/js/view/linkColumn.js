...
export default Marionette.LayoutView.extend({
  ...
  initialize() {
    ...
    this._radio.vent.on(
      'map:zoomChanged map:centerChanged',
      this.renderLinkUrl,
      this
    );
    this._radio.vent.on(
  ...
  renderIframeCode() {
    const html = this.templateIframe({
      ...
      iframeWidthUnit:
        this.ui.iframeWidthUnit.html() === 'px'
          ? ''
          : this.ui.iframeWidthUnit.html(),
      iframeHeightUnit:
        this.ui.iframeHeightUnit.html() === 'px'
          ? ''
          : this.ui.iframeHeightUnit.html(),
