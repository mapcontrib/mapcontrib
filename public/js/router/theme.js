...
export default Backbone.Router.extend({
  routes: {
    ...
    'contribute/edit/:osmType/:osmId/iD/*presetName':
      'routeContributeEditIDPreset',
    ...
    'admin/setting/cache-archive/:layerUuid/*osmId':
      'routeAdminSettingCacheArchiveDetail',
    ...
    'admin/locale/:locale/preset/category/edit/:uuid':
      'routeAdminLocalePresetCategoryEdit',
