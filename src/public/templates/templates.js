...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<section id="edit_poi_layer_column" class="column">\n\t<header>\n\t\t<button type="button" class="btn btn-link pull-right close_btn">\n\t\t\t<i class="fa fa-close"></i>\n\t\t</button>\n\n\t\t<h2 data-l10n-id="editPoiLayerColumn_title"></h2>\n\t</header>\n\n\t<div class="container-fluid content">\n\t\t<div class="row">\n\t\t\t<div class="col-xs-12">\n\t\t\t\t<form>\n\t\t\t\t\t<div class="form-group append-xs-1">\n\t\t\t\t\t\t<label for="layer_name" class="control-label" data-l10n-id="editSettingColumn_layerName"></label>\n\t\t\t\t\t\t<input type="text" class="form-control" id="layer_name" value="' +
((__t = ( name )) == null ? '' : __t) +
'">\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class="form-group append-xs-1">\n\t\t\t\t\t\t<label for="layer_description" class="control-label" data-l10n-id="editSettingColumn_layerDescription"></label>\n\t\t\t\t\t\t<textarea rows="3" class="form-control" id="layer_description">' +
((__t = ( description )) == null ? '' : __t) +
'</textarea>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class="form-group append-xs-1">\n\t\t\t\t\t\t<label for="layer_overpass_request" class="control-label" data-l10n-id="editSettingColumn_layerOverpassRequest"></label>\n\t\t\t\t\t\t<textarea rows="7" class="form-control" id="layer_overpass_request">' +
((__t = ( overpassRequest )) == null ? '' : __t) +
'</textarea>\n\t\t\t\t\t</div>\n\n\t\t\t\t\t<div class="form-group append-xs-1">\n\t\t\t\t\t\t<label for="layer_popup_content" class="control-label" data-l10n-id="editSettingColumn_layerPopupContent"></label>\n\t\t\t\t\t\t<textarea rows="3" class="form-control" id="layer_popup_content">' +
