...
this["JST"]["editPresetColumn.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<section id="edit_preset_column" class="column right orange">\n    <header>\n        <button type="button" class="btn btn-link btn-lg pull-right close_btn">\n            <i class="fa fa-close"></i>\n        </button>\n\n        <h2 data-l10n-id="editPresetColumn_title"></h2>\n    </header>\n\n    <div class="container-fluid content">\n        <div class="row">\n            <div class="col-xs-12">\n                <form>\n                    <div class="rg_preset_list"></div>\n\n                    <div class="sticky-footer">\n                        <button type="button" class="btn btn-primary btn-block add_btn" data-l10n-id="editPresetColumn_addPreset"></button>\n                    </div>\n                </form>\n            </div>\n        </div>\n    </div>\n</section>\n';

}
return __p
};

this["JST"]["editPresetListEmpty.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<p class="text-center"><em data-l10n-id="editPresetColumn_clickButton"></em></p>\n';

}
return __p
};

this["JST"]["editPresetListItem.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="reorder_icon"><i class="fa fa-bars fa-fw"></i></div>\n' +
...
this["JST"]["editPresetTagsColumn.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
...
this["JST"]["presetListItem.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="checkbox append-xs-1">\n    <input type="checkbox" id="preset_' +
__e( id ) +
'" class="preset_checkbox" value="' +
__e( id ) +
'"' +
__e( checked ) +
'>\n    <label for="preset_' +
...
this["JST"]["ui/form/contribNodeTags/listItem.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="form-group append-xs-2">\n    <div class="input-group">\n        <input type="text" class="form-control key" data-l10n-id="uiFormNodeTags_key" value="' +
__e( key ) +
...
this["JST"]["ui/form/presetNodeTags/listItem.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class="form-group append-xs-2">\n    <div class="input-group">\n        <input type="text" class="form-control key" data-l10n-id="uiFormNodeTags_key" value="' +
